...
This is basically a one pager portfolio Template project made in HTML/CSS for an imaginary person on the internet.
...
## Demo
https://user-images.githubusercontent.com/108281031/180638467-e27d64cd-2bfb-403e-bbbc-bc6cd5021477.mp4
...
```bash
  git clone https://github.com/Srinivasan-Akash/Portfolio-Project-1.git
```
...
I had took about 1 to 2 hours approximately as i was not tracking the time this project was a bit tougher for me from the other ones as it forced me to know how to select siblings without class, attribute or id selector
